...
// Wire test: the canary that proves all 44 tools land correctly. If a tool
...
describe("calendar-smart wire", () => {
  ...
  it("matches the spec's 44 tool names exactly", () => {
    const expected = [
      // Read agenda (5)
      "list_events",
      "get_event",
      ...
      "get_user_setting",
      "get_colors",
      // Wave 4: event move (1) + group freebusy (1) + bare metadata (1)
      "move_event",
      "freebusy_group",
