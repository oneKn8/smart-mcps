...
3. `email-smart` — Multi-account Gmail send + inbox read + reversible bulk modify (MVP shipped, 18 tools, 240 tests — see [packages/email-smart/README.md](packages/email-smart/README.md))
